...
const DrawCountDown = () => {
  ...
  const { currentRound } = useGetLotteryStatus();
  ...
  return (
    <div className="bg-white rounded-2xl px-6 py-2 shadow-lg">
      <div className="flex justify-between items-center gap-2 mb-2">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-gray-800">
            ...
            <span className="text-blue-600">#{currentRound}</span>
          </h3>
        </div>

        <div className="bg-red-300 animate-pulse w-5 h-5 rounded-full flex justify-center items-center">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl p-2 text-center">
        ...
        <div className="text-2xl font-bold font-mono tracking-wider mb-1 animate-pulse">
